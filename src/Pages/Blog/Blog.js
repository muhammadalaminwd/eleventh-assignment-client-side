...
const Blogs = () => {
    return (
        ...
        <h1 className='question'>Q3: What other services does firebase provide other than authentication?</h1>
        <h4 className='answer'>Ans: There are many services firebase provide other than authentication that given below:<br />
